...
class DFA{
	public static State q[]= new State[5];
	public static State x = new State(-1,false);		//undefined state ->state in whic dfa cannot return
	public static void main(String[] args) {
		/*language that has 00  or 11  */
		String input = "00010101";
		//input = "00100010010";
		...
		for(Character c:input.toCharArray()){
			...
			if(State.currentState==null||State.currentState.getID()==-1)
				break;
		}
